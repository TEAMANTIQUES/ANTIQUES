...
DevId = Config.DevId
SudoIds = {Config.SudoIds,452924443,1054308380}
ANTIQUES = Config.ANTIQUES
TokenBot = Config.TokenBot
NameBot = (DevLeo:get(ANTIQUES..'Abs:NameBot') or 'انتيكا')
--     SOURCE ANTIQUES     --
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:SudoBot:',msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevLeo:sismember(ANTIQUES..'Abs:VipAll:',msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevLeo:sismember(ANTIQUES..'Abs:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevLeo:sismember(ANTIQUES..'Abs:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevLeo:sismember(ANTIQUES..'Abs:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevLeo:sismember(ANTIQUES..'Abs:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevLeo:sismember(ANTIQUES..'Abs:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
DevLeo:set(ANTIQUES.."Abs:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevLeo:sadd(ANTIQUES.."Abs:Groups",IdGps) 
DevLeo:set(ANTIQUES.."Abs:Lock:Bots"..IdGps,"del") DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevLeo:sadd(ANTIQUES..'Abs:AbsConstructor:'..IdGps,IdAbsConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevLeo:sadd(ANTIQUES..'Abs:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevLeo:sadd(ANTIQUES..'Abs:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevLeo:sadd(ANTIQUES..'Abs:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevLeo:set(ANTIQUES.."Abs:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevLeo:set(ANTIQUES.."Abs:Groups:Welcomes"..IdGps,v.Welcomes)   
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
...
--     SOURCE ANTIQUES     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then ANTIQUESTEAM  = "المطور" elseif SecondSudo(msg) then ANTIQUESTEAM = "المطور" elseif SudoBot(msg) then ANTIQUESTEAM = "المطور" elseif ManagerAll(msg) then ANTIQUESTEAM = "المدير" elseif AdminAll(msg) then ANTIQUESTEAM = "الادمن" elseif AbsConstructor(msg) then ANTIQUESTEAM = "المالك" elseif BasicConstructor(msg) then ANTIQUESTEAM = "المنشئ" elseif Constructor(msg) then ANTIQUESTEAM = "المنشئ" elseif Manager(msg) then ANTIQUESTEAM = "المدير" elseif Admin(msg) then ANTIQUESTEAM = "الادمن" else ANTIQUESTEAM = "العضو" end return ANTIQUESTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(452924443) then ANTIQUESTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(ANTIQUES) then ANTIQUESTEAM = 'البوت' elseif SudoId(user_id) then ANTIQUESTEAM = 'المطور الاساسي' elseif DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:', user_id) then ANTIQUESTEAM = 'المطور الثانوي' elseif DevLeo:sismember(ANTIQUES..'Abs:SudoBot:', user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevLeo:sismember(ANTIQUES..'Abs:ManagerAll:', user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevLeo:sismember(ANTIQUES..'Abs:AdminAll:', user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevLeo:sismember(ANTIQUES..'Abs:VipAll:', user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevLeo:sismember(ANTIQUES..'Abs:AbsConstructor:'..chat_id, user_id) then ANTIQUESTEAM = 'المالك' elseif DevLeo:sismember(ANTIQUES..'Abs:BasicConstructor:'..chat_id, user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..chat_id, user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevLeo:sismember(ANTIQUES..'Abs:Managers:'..chat_id, user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevLeo:sismember(ANTIQUES..'Abs:Admins:'..chat_id, user_id) then ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..chat_id, user_id) then  ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevLeo:sismember(ANTIQUES..'Abs:Cleaner:'..chat_id, user_id) then  ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else ANTIQUESTEAM = DevLeo:get(ANTIQUES.."Abs:mem:Rd"..chat_id) or 'العضو' end return ANTIQUESTEAM end
--     SOURCE ANTIQUES     --
...
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:', user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:SudoBot:', user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:ManagerAll:', user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:AdminAll:', user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:VipAll:', user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:AbsConstructor:'..chat_id, user_id) then
var = true
elseif DevLeo:sismember(ANTIQUES..'Abs:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..chat_id, user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:Managers:'..chat_id, user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:Admins:'..chat_id, user_id) then
var = true  
elseif DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local abs = (ANTIQUES..'Abs:Filters:'..msg.chat_id_)
if abs then
local names = DevLeo:hkeys(abs)
...
local var = true 
if DevLeo:get(ANTIQUES.."Abs:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevLeo:get(ANTIQUES..'Abs:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevLeo:get(ANTIQUES..'Abs:ChText') then
local ChText = DevLeo:get(ANTIQUES..'Abs:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevLeo:get(ANTIQUES.."Abs:ChId"))
local GetInfo = JSON.decode(Check)
...
if DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevLeo:sismember(ANTIQUES..'Abs:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevLeo:sismember(ANTIQUES..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(ANTIQUES..'Abs:Managers:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(ANTIQUES..'Abs:Admins:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(ANTIQUES..'Abs:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(ANTIQUES..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevLeo:srem(ANTIQUES..'Abs:Constructor:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Managers:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Admins:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Cleaner:'..data.chat_id_,data.sender_user_id_)
...
if DevLeo:get(ANTIQUES.."Abs:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "⌔︙تم الغاء امر تغير المطور الاساسي") 
DevLeo:del(ANTIQUES.."Abs:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevLeo:get(ANTIQUES.."Abs:NewDev"..data.sender_user_id_)
...
if DataText == '/YesRolet' and DevLeo:get(ANTIQUES.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevLeo:smembers(ANTIQUES..'Abs:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevLeo:del(ANTIQUES..'Abs:ListRolet'..data.chat_id_) 
DevLeo:del(ANTIQUES.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "⌔︙*صاحب الحظ* -› ["..UserName.."]\n⌔︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevLeo:del(ANTIQUES..'Abs:ListRolet'..data.chat_id_) 
DevLeo:del(ANTIQUES.."Abs:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevLeo:del(ANTIQUES.."Abs:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevLeo:sismember(ANTIQUES..'Abs:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevLeo:sadd(ANTIQUES..'Abs:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HAQEK')..')\n⌔︙تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:sadd(ANTIQUES..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Muted:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HAQEK')..')\n⌔︙تم كتمه من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:Muted:'..data.chat_id_,dp.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Ban:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HAQEK')..')\n⌔︙تم حظره من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevLeo:srem(ANTIQUES..'Abs:Ban:'..data.chat_id_,dp.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Tkeed:'..data.chat_id_,dp.id_)
...
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
if dp.first_name_ == false then
Dev_Leo(data.chat_id_, data.id_, 1, "⌔︙الحساب محذوف", 1, "md")
return false  
end
local Text = '⌔︙قم باستعمال الازرار لرفع العضو -› ⤈\n⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HAQEK')..')'
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId},{text="رفع مطور",callback_data=data.sender_user_id_..":SetSudoBot:"..AbsId}},{{text="رفع مطور ثانوي",callback_data=data.sender_user_id_..":SetSecondSudo:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId},{text="رفع مطور",callback_data=data.sender_user_id_..":SetSudoBot:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
end 
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
DevLeo:del(ANTIQUES..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevLeo:smembers(ANTIQUES..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
if DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌔︙تم انهاء وحفظ -› "..#List.." من الردود المتعدده للامر -› "..Abbs) 
DevLeo:del(ANTIQUES..'Abs:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Text:GpTexts'..Abbs..data.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Manager:GpRedod'..data.chat_id_,Abbs)
else
EditMsg(Chat_Id2, Msg_Id2, "⌔︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevLeo:get(ANTIQUES..'Abs:Help')
local Text = [[
...
local Help = DevLeo:get(ANTIQUES..'Abs:Help1')
local Text = [[
...
local Help = DevLeo:get(ANTIQUES..'Abs:Help2')
local Text = [[
⌔︙اوامر الادمنيه -› ⤈
━─━─━─ ⌔ ─━─━─━
⌔︙الاعدادت
...
local Help = DevLeo:get(ANTIQUES..'Abs:Help3')
local Text = [[
⌔︙اوامر المدراء -› ⤈
━─━─━─ ⌔ ─━─━─━
⌔︙فحص البوت
...
local Help = DevLeo:get(ANTIQUES..'Abs:Help4')
local Text = [[
⌔︙اوامر المنشئين -› ⤈
━─━─━─ ⌔ ─━─━─━
⌔︙تنزيل الكل
...
local Help = DevLeo:get(ANTIQUES..'Abs:Help5')
local Text = [[
⌔︙اوامر المطورين -› ⤈
━─━─━─ ⌔ ─━─━─━
⌔︙الكروبات
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevLeo:get(ANTIQUES..'Abs:Help6')
local Text = [[
⌔︙اوامر الاعضاء -› ⤈
━─━─━─ ⌔ ─━─━─━
...
if text and text:match('^'..(DevLeo:get(ANTIQUES..'Abs:NameBot') or "انتيكا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevLeo:get(ANTIQUES..'Abs:NameBot') or "انتيكا")..' ','')
end
...
for k,v in pairs(List) do
var = DevLeo:get(ANTIQUES.."Comd:New:rt:Abs:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevLeo:smembers(ANTIQUES.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevLeo:del(ANTIQUES.."Comd:New:rt:Abs:"..v..msg.chat_id_)
...
DevLeo:del(ANTIQUES.."Comd:New:rt:Abs:"..ComdNew..msg.chat_id_)
...
DevLeo:set(ANTIQUES.."Comd:New:rt:Abs:"..textn..msg.chat_id_,text)
...
if DevLeo:sismember(ANTIQUES.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrabs = DevLeo:get(ANTIQUES.."Comd:New:rt:Abs:"..DEV_ABBAS..msg.chat_id_)
...
DevLeo:set(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
DevLeo:sadd(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'HAQEK')..')'..' ❩\n⌔︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevLeo:set(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrabs == "مدير" and Manager(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'HAQEK')..')'..' ❩\n⌔︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevLeo:set(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)  
DevLeo:sadd(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevLeo:del(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'HAQEK')..')'..' ❩\n⌔︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevLeo:srem(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
DevLeo:del(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrabs == "مدير" and Manager(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'HAQEK')..')'..' ❩\n⌔︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevLeo:srem(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
DevLeo:del(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrabs == "عضو" then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'HAQEK')..')'..' ❩\n⌔︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
end
...
if result.id_ then
local mrabs = DevLeo:get(ANTIQUES.."Comd:New:rt:Abs:"..text1[2]..msg.chat_id_)
if mrabs == "مميز" and VipMem(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:sadd(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.id_)
DevLeo:set(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.id_)
DevLeo:set(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrabs == "مدير" and Manager(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:sadd(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.id_)
DevLeo:set(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrabs == "عضو" then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.id_)
DevLeo:del(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrabs == "ادمن" and Admin(msg) then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:srem(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.id_)
DevLeo:del(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrabs == "مدير" and Manager(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:srem(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.id_)
DevLeo:del(ANTIQUES.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrabs == "عضو" then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'HAQEK')..')'..' ❩\n⌔︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevLeo:incr(ANTIQUES..'Abs:UsersMsgs'..ANTIQUES..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:incr(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:incr(ANTIQUES..'Abs:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevLeo:sismember(ANTIQUES.."Abs:Users",msg.chat_id_) then
DevLeo:sadd(ANTIQUES.."Abs:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not DevLeo:get(ANTIQUES..'Abs:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=ANTIQUES},function(arg,dp) 
local inline = {{{text="⌁ اضفني في مجموعتك ⌁",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
local start = DevLeo:get(ANTIQUES.."Abs:Start:Bot")
if start then 
Start_Source = start
else
...
DevLeo:setex(ANTIQUES..'Abs:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     SOURCE ANTIQUES     --
if not SecondSudo(msg) and not DevLeo:sismember(ANTIQUES..'Abs:Ban:Pv',msg.sender_user_id_) and not DevLeo:get(ANTIQUES..'Abs:Texting:Pv') then
...
DevLeo:sadd(ANTIQUES..'Abs:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '⌔︙العضو -› ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⌔︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevLeo:srem(ANTIQUES..'Abs:Ban:Pv',data.id_)  
return false  
end 
...
--     SOURCE ANTIQUES     --
if text and DevLeo:get(ANTIQUES..'Abs:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Start:Bots'..msg.sender_user_id_) 
return false
end
DevLeo:set(ANTIQUES.."Abs:Start:Bot",text)  
...
DevLeo:set(ANTIQUES..'Abs:Start:Bots'..msg.sender_user_id_,true) 
...
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Texting:Pv') 
end
if text == 'تعطيل التواصل' or text == '-› تعطيل التواصل ⌁' then  
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Texting:Pv',true) 
end
end
--     SOURCE ANTIQUES     --
...
DevLeo:incr(ANTIQUES..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:set(ANTIQUES.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevLeo:get(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevLeo:sadd(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevLeo:srem(ANTIQUES.."Abs:Groups", msg.chat_id_) 
...
if DevLeo:get(ANTIQUES..'Abs:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevLeo:incr(ANTIQUES..'Abs:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevLeo:incr(ANTIQUES..'Abs:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     SOURCE ANTIQUES     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevLeo:get(ANTIQUES..'Abs:Lock:FreeBot'..ANTIQUES) then
if ChatType == 'pv' then
...
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevLeo:srem(ANTIQUES..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevLeo:sadd(ANTIQUES.."Abs:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevLeo:sadd(ANTIQUES.."Abs:AbsConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevLeo:srem(ANTIQUES.."Abs:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevLeo:srem(ANTIQUES.."Abs:AbsConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevLeo:sismember(ANTIQUES..'Abs:Groups',msg.chat_id_) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevLeo:get(ANTIQUES..'Abs:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙عدد اعضاء المجموعه اقل من -› *'..(DevLeo:get(ANTIQUES..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","⌔︙تم تفعيل المجموعه "..dp.title_)  
DevLeo:sadd(ANTIQUES.."Abs:Groups",msg.chat_id_)
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevLeo:set(ANTIQUES.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
...
if not DevLeo:sismember(ANTIQUES.."Abs:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevLeo:sadd(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevLeo:get(ANTIQUES.."Abs:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = DevLeo:smembers(ANTIQUES.."Abs:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = DevLeo:smembers(ANTIQUES.."Abs:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = DevLeo:smembers(ANTIQUES.."Abs:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevLeo:get(ANTIQUES..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙الرد -› '..msg.content_.text_..' للكلمه -› '..GetGpTexts..' تم حذفها',  1, "html")
DevLeo:del(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙الكلمه -› '..msg.content_.text_..' تم حذفها',  1, "html")
DevLeo:del(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevLeo:get(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙الكلمه -› '..msg.content_.text_..' تم حذفها',  1, "html")
DevLeo:del(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevLeo:get(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙الكلمه -› '..msg.content_.text_..' تم حذفها',  1, "html")
DevLeo:del(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_)
DevLeo:del(ANTIQUES.."Abs:Gif:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Voice:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Audio:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Photo:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Stecker:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Video:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:File:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Text:AllRed"..msg.content_.text_)
DevLeo:del(ANTIQUES.."Abs:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     SOURCE ANTIQUES     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevLeo:get(ANTIQUES..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevLeo:smembers(ANTIQUES..'Abs:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙⌔︙تم الغاء عملية حفظ الردود المتعدده للامر -› "..GetGpTexts ,  1, "md")
DevLeo:del(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevLeo:sadd(ANTIQUES..'Abs:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevLeo:sismember(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_,text) then
local ANTIQUESTEAM =  DevLeo:smembers(ANTIQUES..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Leo(msg.chat_id_, msg.id_, 1, '['..ANTIQUESTEAM[math.random(#ANTIQUESTEAM)]..']' , 1, 'md')  
end
end
--     SOURCE ANTIQUES     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevLeo:get(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevLeo:get(ANTIQUES..'DelManagerRep'..msg.chat_id_)
DevLeo:srem(ANTIQUES..'Abs:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء حفظ الرد', 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(ANTIQUES..'DelManagerRep'..msg.chat_id_)
return false
end
DevLeo:del(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevLeo:get(ANTIQUES..'Abs:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevLeo:set(ANTIQUES..'Abs:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevLeo:set(ANTIQUES..'Abs:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevLeo:set(ANTIQUES..'Abs:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevLeo:set(ANTIQUES..'Abs:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevLeo:set(ANTIQUES..'Abs:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevLeo:set(ANTIQUES..'Abs:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevLeo:set(ANTIQUES..'Abs:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevLeo:set(ANTIQUES..'Abs:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevLeo:get(ANTIQUES..'Abs:Lock:GpRed'..msg.chat_id_) then 
if DevLeo:get(ANTIQUES..'Abs:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(ANTIQUES..'Abs:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevLeo:get(ANTIQUES..'Abs:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(ANTIQUES..'Abs:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevLeo:get(ANTIQUES..'Abs:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES..'Abs:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevLeo:get(ANTIQUES..'Abs:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES..'Abs:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevLeo:get(ANTIQUES..'Abs:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES..'Abs:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevLeo:get(ANTIQUES..'Abs:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES..'Abs:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevLeo:get(ANTIQUES..'Abs:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(ANTIQUES..'Abs:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevLeo:get(ANTIQUES..'Abs:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function ANTIQUESTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevLeo:get(ANTIQUES..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevLeo:get(ANTIQUES..'Abs:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevLeo:get(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevLeo:get(ANTIQUES..'DelSudoRep')
DevLeo:del(ANTIQUES.."Abs:Sudo:AllRed",DelSudoRep)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء حفظ الرد', 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Add:AllText"..msg.sender_user_id_)
DevLeo:del(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_)
DevLeo:del(ANTIQUES.."DelSudoRep")
return false
end
DevLeo:del(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevLeo:get(ANTIQUES.."Abs:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevLeo:set(ANTIQUES.."Abs:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevLeo:set(ANTIQUES.."Abs:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevLeo:set(ANTIQUES.."Abs:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevLeo:set(ANTIQUES.."Abs:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevLeo:set(ANTIQUES.."Abs:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevLeo:set(ANTIQUES.."Abs:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevLeo:set(ANTIQUES.."Abs:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevLeo:set(ANTIQUES.."Abs:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم حفظ الرد الجديد', 1, 'md') 
DevLeo:del(ANTIQUES.."Abs:Add:AllText"..msg.sender_user_id_)
DevLeo:del(ANTIQUES..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevLeo:get(ANTIQUES..'Abs:Lock:AllRed'..msg.chat_id_) then
if DevLeo:get(ANTIQUES.."Abs:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(ANTIQUES.."Abs:Video:AllRed"..msg.content_.text_))
end
if DevLeo:get(ANTIQUES.."Abs:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(ANTIQUES.."Abs:File:AllRed"..msg.content_.text_))
end
if DevLeo:get(ANTIQUES.."Abs:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES.."Abs:Voice:AllRed"..msg.content_.text_))
end
if DevLeo:get(ANTIQUES.."Abs:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES.."Abs:Audio:AllRed"..msg.content_.text_))
end
if DevLeo:get(ANTIQUES.."Abs:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES.."Abs:Photo:AllRed"..msg.content_.text_))
end
if  DevLeo:get(ANTIQUES.."Abs:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(ANTIQUES.."Abs:Gif:AllRed"..msg.content_.text_))
end
if DevLeo:get(ANTIQUES.."Abs:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(ANTIQUES.."Abs:Stecker:AllRed"..msg.content_.text_))
end
if DevLeo:get(ANTIQUES.."Abs:Text:AllRed"..msg.content_.text_) then
function ANTIQUESTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevLeo:get(ANTIQUES..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevLeo:get(ANTIQUES.."Abs:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevLeo:sismember(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevLeo:sadd(ANTIQUES..'Abs:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     SOURCE ANTIQUES     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= ANTIQUES then
floods = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevLeo:get(ANTIQUES.."Abs:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevLeo:setex(ANTIQUES.."Abs:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     SOURCE ANTIQUES     --
...
DevLeo:set(ANTIQUES..'Abs:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevLeo:get(ANTIQUES..'Abs:PinnedMsg'..msg.chat_id_)
if pin_id and DevLeo:get(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevLeo:get(ANTIQUES..'Abs:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevLeo:del(ANTIQUES..'Abs:viewget'..msg.sender_user_id_)
else
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevLeo:get(ANTIQUES..'Abs:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevLeo:get(ANTIQUES..'Abs:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevLeo:get(ANTIQUES..'Abs:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevLeo:get(ANTIQUES..'Abs:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevLeo:get(ANTIQUES..'Abs:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevLeo:get(ANTIQUES..'Abs:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevLeo:get(ANTIQUES..'Abs:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevLeo:get(ANTIQUES..'Abs:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     SOURCE ANTIQUES     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevLeo:get(ANTIQUES..'Abs:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevLeo:get(ANTIQUES..'Abs:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevLeo:get(ANTIQUES..'Abs:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevLeo:get(ANTIQUES.."Abs:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     SOURCE ANTIQUES     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevLeo:get(ANTIQUES..'Abs:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = ANTIQUES,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(ANTIQUES) then 
if DevLeo:sismember(ANTIQUES..'Abs:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n⌔︙ارسل -› الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n⌔︙بعد ذلك يرجى ارسال امر -› تفعيل\n⌔︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevLeo:get(ANTIQUES.."Abs:Text:BotWelcome") then AbsText = DevLeo:get(ANTIQUES.."Abs:Text:BotWelcome") else AbsText = "⌔︙مرحبا انا بوت اسمي "..NameBot.."\n⌔︙حالة المجموعه -› "..BotText.."\n━─━─━─ ⌔ ─━─━─━" end 
if DevLeo:get(ANTIQUES.."Abs:Photo:BotWelcome") then AbsPhoto = DevLeo:get(ANTIQUES.."Abs:Photo:BotWelcome") elseif abbas.photos_[0] then AbsPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else AbsPhoto = nil end 
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     SOURCE ANTIQUES     --
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(ANTIQUES..'Abs:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevLeo:get(ANTIQUES..'Abs:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevLeo:get(ANTIQUES..'Abs:Spam:Text'..msg.chat_id_))
end
if DevLeo:get(ANTIQUES..'Abs:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     SOURCE ANTIQUES     --
if DevLeo:get(ANTIQUES.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"⌔︙تم الغاء حفظ الرابط")       
DevLeo:del(ANTIQUES.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevLeo:set(ANTIQUES.."Abs:Groups:Links"..msg.chat_id_,Link)
...
DevLeo:incrby(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
...
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevLeo:get(ANTIQUES.."Abs:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevLeo:get(ANTIQUES.."Abs:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌔︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevLeo:get(ANTIQUES.."Abs:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevLeo:get(ANTIQUES.."Abs:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevLeo:get(ANTIQUES.."Abs:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Groups') 
local BotName = (DevLeo:get(ANTIQUES.."Abs:NameBot") or 'انتيكا')
local GetJson = '{"BotId": '..ANTIQUES..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevLeo:get(ANTIQUES.."Abs:Groups:Links"..v)
Welcomes = DevLeo:get(ANTIQUES..'Abs:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
AbsConstructors = DevLeo:smembers(ANTIQUES..'Abs:AbsConstructor:'..v)
Constructors = DevLeo:smembers(ANTIQUES..'Abs:BasicConstructor:'..v)
BasicConstructors = DevLeo:smembers(ANTIQUES..'Abs:Constructor:'..v)
Managers = DevLeo:smembers(ANTIQUES..'Abs:Managers:'..v)
Admis = DevLeo:smembers(ANTIQUES..'Abs:Admins:'..v)
Vips = DevLeo:smembers(ANTIQUES..'Abs:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
DevLeo:set(ANTIQUES..'Abs:ChId',data.id_)
else
...
--     SOURCE ANTIQUES     --
if DevLeo:get(ANTIQUES.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevLeo:del(ANTIQUES.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء الامر', 1, 'md')
return false 
end 
DevLeo:del(ANTIQUES.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
...
if DevLeo:get(ANTIQUES..'Abs:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevLeo:del(ANTIQUES..'Abs:NameBot'..msg.sender_user_id_)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم حفظ اسم البوت ', 1, 'html')
DevLeo:del(ANTIQUES..'Abs:NameBot'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:NameBot', text)
return false 
end
--     SOURCE ANTIQUES     --
if text == "الرابط" then
if not DevLeo:get(ANTIQUES.."Abs:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevLeo:get(ANTIQUES.."Private:Group:Link"..msg.chat_id_) 
...
Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM[math.random(#ANTIQUESTEAM)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevLeo:get(ANTIQUES..'Abs:NameBot') or 'انتيكا') 
local ANTIQUESTEAM = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM[math.random(#ANTIQUESTEAM)] , 1, 'html') 
return false
end
if text and text == (DevLeo:get(ANTIQUES..'Abs:NameBot') or 'انتيكا') then 
NameBot = (DevLeo:get(ANTIQUES..'Abs:NameBot') or 'انتيكا')
local ANTIQUESTEAM = {'كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' '} 
Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM[math.random(#ANTIQUESTEAM)] , 1, 'html') 
return false 
end
if text =='نقاطي' and ChCheck(msg) then 
if tonumber((DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙لم تربح اي نقطه\n⌔︙ارسل -› الالعاب للعب', 1, 'md')
else 
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙عدد النقاط التي ربحتها -› '..(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevLeo:del(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevLeo:del(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع نقاطك', 1, 'md') end
--     SOURCE ANTIQUES     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) then
if not DevLeo:get(ANTIQUES..'Abs:Lock:Games'..msg.chat_id_) then
DevLeo2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum'..msg.chat_id_) and not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
ANTIQUESTEAM = '⌔︙مبروك لقد ربحت في اللعبه \n⌔︙ارسل -› سمايلات للعب مره اخرى'
Dev_Leo(msg.chat_id_, msg.id_, 1,ANTIQUESTEAM, 1, 'md')
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevLeo:set(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_,true)
end
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum2'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum2'..msg.chat_id_) and not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum3'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum3'..msg.chat_id_) and not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
...
DevLeo2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum4'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum4'..msg.chat_id_) and not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum5'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum5'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(ANTIQUES..'Abs:GameNum5'..msg.chat_id_)
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum6'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum6'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(ANTIQUES..'Abs:GameNum6'..msg.chat_id_)
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum7'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum7'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(ANTIQUES..'Abs:GameNum7'..msg.chat_id_)
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(ANTIQUES..'Abs:GameNum8'..msg.chat_id_,name)
DevLeo:del(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(ANTIQUES..'Abs:GameNum8'..msg.chat_id_) then
if not DevLeo:get(ANTIQUES..'Abs:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(ANTIQUES..'Abs:GameNum8'..msg.chat_id_)
...
if text == 'روليت' then
if not DevLeo:get(ANTIQUES..'Abs:Lock:Games'..msg.chat_id_) then
DevLeo:del(ANTIQUES.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevLeo:del(ANTIQUES..'Abs:ListRolet'..msg.chat_id_)  
DevLeo:setex(ANTIQUES.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevLeo:get(ANTIQUES.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "⌔︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevLeo:set(ANTIQUES.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '⌔︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n⌔︙الفائز يحصل على 5 نقاط عدد المطلوبين -› '..text..' لاعب'
end
DevLeo:del(ANTIQUES.."Abs:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevLeo:get(ANTIQUES.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevLeo:sismember(ANTIQUES..'Abs:ListRolet'..msg.chat_id_,text) then
...
DevLeo:sadd(ANTIQUES..'Abs:ListRolet'..msg.chat_id_,text)
local CountAdd = DevLeo:get(ANTIQUES.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevLeo:scard(ANTIQUES..'Abs:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevLeo:del(ANTIQUES.."Abs:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevLeo:setex(ANTIQUES.."Abs:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
if not DevLeo:get(ANTIQUES..'Abs:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
DevLeo0 = (DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevLeo:incrby(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevLeo0)
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙تم بيع '..(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n⌔︙كل نقطه تساوي 50 رساله', 'md')
DevLeo:del(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     SOURCE ANTIQUES     --
...
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevLeo:sadd(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevLeo:get(ANTIQUES.."Abs:Left:Bot"..ANTIQUES) and not SecondSudo(msg) then
...
local msguser = tonumber(DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevLeo:get(ANTIQUES..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
function ANTIQUESTEAM(extra,result,success)
if DevLeo:get(ANTIQUES.."Abs:Send:Bot"..ANTIQUES) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"⌔︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevLeo:smembers(ANTIQUES.."Abs:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevLeo:smembers(ANTIQUES.."Abs:Users")
...
DevLeo:set(ANTIQUES..'Abs:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
𓄇[˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.](https://t.me/HAQEK)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if DevLeo:get(ANTIQUES.."Abs:Kick:Me"..msg.chat_id_) then
...
DevLeo:set(ANTIQUES.."Abs:Kick:Me"..msg.chat_id_, true)
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل امر اطردني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevLeo:del(ANTIQUES.."Abs:Kick:Me"..msg.chat_id_)
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل امر اطردني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
end
--     SOURCE ANTIQUES     --
if text == "نزلني" and ChCheck(msg) then
if DevLeo:get(ANTIQUES.."Abs:Del:Me"..msg.chat_id_) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
...
DevLeo:set(ANTIQUES.."Abs:Del:Me"..msg.chat_id_, true)
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل امر نزلني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevLeo:del(ANTIQUES.."Abs:Del:Me"..msg.chat_id_)
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل امر نزلني'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
end
--     SOURCE ANTIQUES     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:TagAll'..msg.chat_id_)
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevLeo:get(ANTIQUES..'Abs:Lock:TagAll'..msg.chat_id_) then
...
local EntryNumber = (DevLeo:get(ANTIQUES..'Abs:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevLeo:get(ANTIQUES..'Abs:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevLeo:get(ANTIQUES..'Abs:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
--     SOURCE ANTIQUES     --
if text == "اهمس" or text == "همسه" or text == "اريد بوت الهمسه" or text == "دزلي بوت الهمسه" or  text == "دزولي بوت الهمسه" then  Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙@cCVCcBoT', 1, 'md') end
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevLeo:get(ANTIQUES..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙عدد جهاتك المضافه -› *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevLeo:get(ANTIQUES..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙عدد تعديلاتك -› *❨ "..edit_msg.." ❩* ", 1, 'md') end
if text == "ايديي" and ChCheck(msg) then Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙ايديك -› ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevLeo:del(ANTIQUES..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevLeo:del(ANTIQUES..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     SOURCE ANTIQUES     --
if text == "المطور" then 
local DevText = DevLeo:get(ANTIQUES.."DevText")
if DevLeo:get(ANTIQUES.."Abs:ChId") then local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevLeo:get(ANTIQUES.."Abs:ChId")) local GetInfo = JSON.decode(Check) local DevCh1 = GetInfo.result.username DevCh = '\n⌔︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/HAQEK")}}}
local msg_id = msg.id_/2097152/0.5
...
Dev_Leo(msg.chat_id_, msg.id_, 1, DevText, 1, "md")
end
else
if abbas.photos_[0] then
keyboard = {} 
...
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙*Dev User* ↬ ['..DevUser..']\n⌔︙*Dev Id* ↬ '..DevId..DevCh, 1, "md")
end
end
end,nil)
end,nil)
...
Text = "• *The developer and programmer of this source is* : [MaLaTH Al DleM](https://t.me/XIIISI)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='- 𝗆𝖺𝗅𝖺𝗍𝗁 𝖺𝗅 𝖽𝗅𝖾𝗆 .',url="t.me/XIIISI"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&photo=https://t.me/XIIISI&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     SOURCE ANTIQUES     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') then 
if not DevLeo:get(ANTIQUES..'Abs:Lock:Stupid'..msg.chat_id_) then
...
if tonumber(result.id_) == tonumber(452924443) then 
Dev_Leo(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevLeo:sismember(ANTIQUES.."Abs:AbsConstructor:"..msg.chat_id_,result.id_) then
Dev_Leo(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if tonumber(result.sender_user_id_) == tonumber(452924443) then  
Dev_Leo(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevLeo:sismember(ANTIQUES.."Abs:AbsConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Leo(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ANTIQUESTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
if DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevLeo:sismember(ANTIQUES..'Abs:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevLeo:sismember(ANTIQUES..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevLeo:sismember(ANTIQUES..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevLeo:sismember(ANTIQUES..'Abs:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevLeo:sismember(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevLeo:sismember(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevLeo:srem(ANTIQUES..'Abs:SecondSudo:', result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:SudoBot:', result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:ManagerAll:', result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:AdminAll:', result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:VipAll:', result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevLeo:sismember(ANTIQUES..'Abs:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevLeo:sismember(ANTIQUES..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevLeo:sismember(ANTIQUES..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevLeo:sismember(ANTIQUES..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevLeo:sismember(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevLeo:sismember(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevLeo:sismember(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevLeo:sismember(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevLeo:srem(ANTIQUES..'Abs:SecondSudo:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:SudoBot:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:ManagerAll:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:AdminAll:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:VipAll:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
DevLeo:srem(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,result.id_)
DevLeo:srem(ANTIQUES..'Abs:Managers:'..msg.chat_id_, result.id_)
DevLeo:srem(ANTIQUES..'Abs:Admins:'..msg.chat_id_, result.id_)
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..msg.chat_id_, result.id_)
DevLeo:srem(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_, result.id_)
elseif AbsDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
DevLeo:srem(ANTIQUES..'Abs:SudoBot:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:ManagerAll:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:AdminAll:', result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:SecondSudo:',result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:SecondSudo:',result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:SecondSudo:',user)
...
DevLeo:srem(ANTIQUES..'Abs:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:SudoBot:',result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:SudoBot:',user)
...
DevLeo:srem(ANTIQUES..'Abs:SudoBot:',user)
...
DevLeo:sadd(ANTIQUES..'Abs:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:ManagerAll:',result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:ManagerAll:',user)
...
DevLeo:srem(ANTIQUES..'Abs:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:AdminAll:',result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:AdminAll:',user)
...
DevLeo:srem(ANTIQUES..'Abs:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:VipAll:',result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:VipAll:',user)
...
DevLeo:srem(ANTIQUES..'Abs:VipAll:',user)
...
function raf_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevLeo:srem(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,result.id_)
...
DevLeo:srem(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:Constructor:'..msg.chat_id_,user)
...
DevLeo:sadd(ANTIQUES..'Abs:Managers:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:Managers:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
DevLeo:sadd(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevLeo:get(ANTIQUES.."Abs:Lock:ProSet"..msg.chat_id_) then 
Dev_Leo(msg.chat_id_, msg.id_, 1,'⌔︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع من قبل المنشئيين', 1, 'md')
return false
end
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..msg.chat_id_,result.sender_user_id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Admins:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:Admins:'..msg.chat_id_,user)
...
DevLeo:sadd(ANTIQUES..'Abs:VipMem:'..msg.chat_id_,user)
...
DevLeo:srem(ANTIQUES..'Abs:VipMem:'..msg.chat_id_,user)
...
local Text = '⌔︙قم باستعمال الازرار لرفع العضو -› ⤈\n⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HAQEK')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
end
...
local Text = '⌔︙قم باستعمال الازرار لتنزيل العضو -› ⤈\n⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HAQEK')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '˛ ᴀɴᴛɪǫᴜᴇs ᴛᴇᴀᴍ 🦇.',url="t.me/HAQEK"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
ANTIQUESTEAM = {"ها هلاو","انطق","كول حبي","تفضل"};
...
DevLeo:del(ANTIQUES.."Abs:Lock:ProSet"..msg.chat_id_)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم تفعيل رفع -› الادمن • المميز', 1, 'md')
end
if text == "تعطيل الرفع" and ChCheck(msg) or text == "تعطيل الترقيه" and ChCheck(msg) then
DevLeo:set(ANTIQUES.."Abs:Lock:ProSet"..msg.chat_id_,"true")
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم تعطيل رفع -› الادمن • المميز', 1, 'md')
end
end
--     SOURCE ANTIQUES     --
--          Kick          --
...
if not Constructor(msg) and DevLeo:get(ANTIQUES.."Abs:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevLeo:sadd(ANTIQUES..'Abs:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
DevLeo:sadd(ANTIQUES..'Abs:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevLeo:sadd(ANTIQUES..'Abs:Ban:'..msg.chat_id_, user)
...
DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_, result.id_)
...
DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and DevLeo:get(ANTIQUES.."Abs:Lock:MuteTked"..msg.chat_id_) then 
...
if DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔︙هو بالفعل مكتوم من المجموعه")  
else
DevLeo:sadd(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌔︙هو بالفعل مكتوم من المجموعه")  
else
DevLeo:sadd(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.id_)
...
if DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌔︙هو بالفعل مكتوم من المجموعه")  
else
DevLeo:sadd(ANTIQUES..'Abs:Muted:'..msg.chat_id_, user)
...
if not DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌔︙هو ليس مكتوم لالغاء كتمه")  
else
DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌔︙هو ليس مكتوم لالغاء كتمه")  
else
DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_, result.id_)
...
if not DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌔︙هو ليس مكتوم لالغاء كتمه")  
else
DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_, user)
...
DevLeo:sadd(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, user)
...
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, result.id_)
...
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, user)
...
if DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevLeo:sadd(ANTIQUES..'Abs:BanAll:', result.sender_user_id_)
...
if DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevLeo:sadd(ANTIQUES..'Abs:BanAll:', result.id_)
...
if DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',user) and not Sudo(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevLeo:sadd(ANTIQUES..'Abs:BanAll:', user)
...
if DevLeo:sismember(ANTIQUES..'Abs:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙*لاتستطيع كتم المطور الثانوي*", 1, 'md')
return false 
end
DevLeo:sadd(ANTIQUES..'Abs:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(ANTIQUES..'Abs:MuteAll:', result.id_)
...
DevLeo:sadd(ANTIQUES..'Abs:MuteAll:', user)
...
DevLeo:srem(ANTIQUES..'Abs:BanAll:', result.sender_user_id_)
DevLeo:srem(ANTIQUES..'Abs:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevLeo:srem(ANTIQUES..'Abs:BanAll:', result.id_)
DevLeo:srem(ANTIQUES..'Abs:MuteAll:', result.id_)
...
DevLeo:srem(ANTIQUES..'Abs:BanAll:', user)
DevLeo:srem(ANTIQUES..'Abs:MuteAll:', user)
...
DevLeo:setex(ANTIQUES.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if DevLeo:get(ANTIQUES.."Abs:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'⌔︙تم الغاء امر تغير المطور الاساسي')
DevLeo:del(ANTIQUES.."Abs:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevLeo:del(ANTIQUES.."Abs:EditDev"..msg.sender_user_id_)
DevLeo:set(ANTIQUES.."Abs:NewDev"..msg.sender_user_id_,dp.id_)
...
--     SOURCE ANTIQUES     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevLeo:get(ANTIQUES..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     SOURCE ANTIQUES     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevLeo:get(ANTIQUES..'Abs:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
...
DevLeo:del(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevLeo:incrby(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
function Reply(extra, result, success)
DevLeo:incrby(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevLeo:get(ANTIQUES..'Abs:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevLeo:sadd(ANTIQUES.."Abs:cleaner"..msg.chat_id_, msg.id_) else DevLeo:sadd(ANTIQUES.."Abs:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevLeo:sismember(ANTIQUES.."Abs:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevLeo:set(ANTIQUES..'Abs:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevLeo:smembers(ANTIQUES..'Abs:VipMem:'..msg.chat_id_)
text = "⌔︙قائمة المميزين -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
...
local List = DevLeo:smembers(ANTIQUES..abs)
text = "⌔︙قائمة الادمنيه -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Managers:'..msg.chat_id_)
text = "⌔︙قائمة المدراء -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Cleaner:'..msg.chat_id_)
text = "⌔︙قائمة المنظفين -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Constructor:'..msg.chat_id_)
text = "⌔︙قائمة المنشئين -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_)
text = "⌔︙قائمة المالكين -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_)
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Muted:'..msg.chat_id_)
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_)
text = "⌔︙قائمة المقيدين -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:Ban:'..msg.chat_id_)
...
local List = DevLeo:hkeys(ANTIQUES..'Abs:Filters:'..msg.chat_id_)
text = "⌔︙قائمة المنع -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevLeo:smembers(ANTIQUES..'Abs:SecondSudo:')
...
local BanAll = DevLeo:smembers(ANTIQUES..'Abs:BanAll:')
local MuteAll = DevLeo:smembers(ANTIQUES..'Abs:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevLeo:smembers(ANTIQUES..'Abs:SudoBot:')
text = "⌔︙قائمة المطورين -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n"
for k,v in pairs(List) do
local sudouser = DevLeo:get(ANTIQUES..'Abs:Sudos'..v) 
local username = DevLeo:get(ANTIQUES..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(ANTIQUES..'Abs:ManagerAll:')
...
local List = DevLeo:smembers(ANTIQUES..'Abs:VipAll:')
...
DevLeo:sadd(ANTIQUES.."Abs:AbsConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevLeo:srem(ANTIQUES.."Abs:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevLeo:srem(ANTIQUES.."Abs:FilterPhoto"..msg.chat_id_,photo)
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevLeo:srem(ANTIQUES.."Abs:FilterAnimation"..msg.chat_id_,idanimation)
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Thwel:Abs'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل تحويل الصيغ'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Thwel:Abs'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevLeo:get(ANTIQUES..'Abs:Thwel:Abs'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevLeo:sismember(ANTIQUES..'Abs:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevLeo:sismember(ANTIQUES..'Abs:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevLeo:sismember(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevLeo:sismember(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevLeo:sismember(ANTIQUES..'Abs:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n⌔︙عدد الكروبات -› '..(DevLeo:get(ANTIQUES..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevLeo:sismember(ANTIQUES..'Abs:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevLeo:sismember(ANTIQUES..'Abs:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevLeo:sismember(ANTIQUES..'Abs:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevLeo:sismember(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevLeo:sismember(ANTIQUES..'Abs:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n⌔︙عدد الكروبات -› '..(DevLeo:get(ANTIQUES..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevLeo:sismember(ANTIQUES..'Abs:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevLeo:sismember(ANTIQUES..'Abs:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevLeo:sismember(ANTIQUES..'Abs:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevLeo:sismember(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevLeo:sismember(ANTIQUES..'Abs:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n⌔︙عدد الكروبات -› '..(DevLeo:get(ANTIQUES..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevLeo:sismember(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevLeo:sismember(ANTIQUES..'Abs:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevLeo:sismember(ANTIQUES..'Abs:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevLeo:sismember(ANTIQUES..'Abs:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevLeo:sismember(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevLeo:sismember(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevLeo:sismember(ANTIQUES..'Abs:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevLeo:sismember(ANTIQUES..'Abs:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevLeo:sismember(ANTIQUES..'Abs:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙الحظر العام -› '..banall..'\n⌔︙الكتم العام -› '..muteall..'\n⌔︙الحظر -› '..banned..'\n⌔︙الكتم -› '..muted..'\n⌔︙التقيد -› '..tkeed, 1, 'md')  
else
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(ANTIQUES..'Abs:BanAll:',result.sender_user_id_) DevLeo:srem(ANTIQUES..'Abs:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,user) DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_,user) DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_,user) DevLeo:srem(ANTIQUES..'Abs:BanAll:',user) DevLeo:srem(ANTIQUES..'Abs:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,user) DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_,user) DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,result.id_) DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.id_) DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.id_) DevLeo:srem(ANTIQUES..'Abs:BanAll:',result.id_) DevLeo:srem(ANTIQUES..'Abs:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_,result.id_) DevLeo:srem(ANTIQUES..'Abs:Ban:'..msg.chat_id_,result.id_) DevLeo:srem(ANTIQUES..'Abs:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevLeo:set(ANTIQUES.."Abs:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevLeo:set(ANTIQUES.."Abs:AllIds:Text",text)
return false
end
...
DevLeo:del(ANTIQUES.."Abs:AllIds:Text")
end
end
--     SOURCE ANTIQUES     --
...
DevLeo:set(ANTIQUES.."Abs:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم حذف كليشة الايدي")  
DevLeo:del(ANTIQUES.."Abs:GpIds:Text"..msg.chat_id_)
end
end
--     SOURCE ANTIQUES     --
if msg.reply_to_message_id_ ~= 0 then
...
function ANTIQUESTEAM(extra,abbas,success)
...
local msgsday = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..ANTIQUES..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevLeo:get(ANTIQUES..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevLeo:get(ANTIQUES..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevLeo:get(ANTIQUES..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevLeo:get(ANTIQUES..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if abbas.photos_[0] then
if not DevLeo:get(ANTIQUES..'Abs:Lock:Id'..msg.chat_id_) then 
if not DevLeo:get(ANTIQUES..'Abs:Lock:Id:Photo'..msg.chat_id_) then 
if DevLeo:get(ANTIQUES.."Abs:AllIds:Text") then
newpicid = DevLeo:get(ANTIQUES.."Abs:AllIds:Text")
...
if not DevLeo:get(ANTIQUES.."Abs:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, abbas.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevLeo:get(ANTIQUES.."Abs:GpIds:Text"..msg.chat_id_)
...
if DevLeo:get(ANTIQUES.."Abs:AllIds:Text") then
newallid = DevLeo:get(ANTIQUES.."Abs:AllIds:Text")
...
if DevLeo:get(ANTIQUES.."Abs:AllIds:Text") then
notpicid = DevLeo:get(ANTIQUES.."Abs:AllIds:Text")
...
if not DevLeo:get(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم قفل التعديل")  
DevLeo:set(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevLeo:set(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم قفل البوتات بالطرد")  
DevLeo:set(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_,"kick")  
end
...
DevLeo:set(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevLeo:get(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevLeo:set(ANTIQUES.."Abs:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم قفل التثبيت")  
DevLeo:set(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_,true)
DevLeo:sadd(ANTIQUES.."Abs:Lock:Pinpin",msg.chat_id_) 
else
...
DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevLeo:get(ANTIQUES..'Abs:Lock:Id:Photo'..msg.chat_id_) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الايدي بالصوره'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevLeo:get(ANTIQUES..'Abs:Lock:Id'..msg.chat_id_) then
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙الايدي بالتاكيد معطل ', 1, 'md')
else
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الايدي بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:Id'..msg.chat_id_,true)
end end
end
--     SOURCE ANTIQUES     --
...
DevLeo:setex(ANTIQUES.."Abs:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' or text == 'انشاء الرابط' then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevLeo:get(ANTIQUES.."Abs:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevLeo:set(ANTIQUES.."Abs:Groups:Links"..msg.chat_id_,LinkGroup) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES.."Abs:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الترحيب بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES.."Abs:Lock:Welcome"..msg.chat_id_)
end
if DevLeo:get(ANTIQUES..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevLeo:del(ANTIQUES..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevLeo:del(ANTIQUES..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevLeo:set(ANTIQUES..'Abs:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevLeo:set(ANTIQUES..'Abs:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم حذف الترحيب")  
DevLeo:del(ANTIQUES..'Abs:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevLeo:get(ANTIQUES..'Abs:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Leo(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     SOURCE ANTIQUES     --
if DevLeo:get(ANTIQUES..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء حفظ الوصف", 1, 'md')
DevLeo:del(ANTIQUES..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevLeo:del(ANTIQUES..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevLeo:set(ANTIQUES..'Abs:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevLeo:set(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevLeo:get(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر المنع', 1, 'md')
DevLeo:del(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم منع الكلمه -› "..text, 1, 'html')
DevLeo:del(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevLeo:hset(ANTIQUES..'Abs:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙ارسل لي الكلمه الان", 1, 'md') 
DevLeo:set(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevLeo:get(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر الغاء المنع', 1, 'md')
DevLeo:del(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevLeo:hget(ANTIQUES..'Abs:Filters:'..msg.chat_id_, text) then  
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙الكلمه -› "..text.." غير ممنوعه", 1, 'html')
DevLeo:del(ANTIQUES.."Abs:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevLeo:hdel(ANTIQUES..'Abs:Filters:'..msg.chat_id_, text)
...
local gps = DevLeo:scard(ANTIQUES.."Abs:Groups") local users = DevLeo:scard(ANTIQUES.."Abs:Users") 
...
local users = DevLeo:scard(ANTIQUES.."Abs:Users")
...
local gps = DevLeo:scard(ANTIQUES.."Abs:Groups")
...
if Number > 1000 then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙لاتستطيع تنظيف اكثر من 1000 رساله', 1, 'md')
return false  
end  
...
local pv = DevLeo:smembers(ANTIQUES.."Abs:Users")
local sendok = 0
for i = 1, #pv do
...
DevLeo:srem(ANTIQUES.."Abs:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevLeo:smembers(ANTIQUES.."Abs:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevLeo:srem(ANTIQUES.."Abs:Groups",group[i]) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:Clean'..msg.chat_id_,true)  
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:Clean'..msg.chat_id_) 
end
...
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙قم بتحديد عدد اكبر من 50 واصغر من 200 للحذف التلقائي', 1, 'md')
else
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم وضع -› *'..Num..'* من الميديا للحذف التلقائي', 1, 'md')
DevLeo:set(ANTIQUES..'Abs:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevLeo:get(ANTIQUES..'Abs:Lock:Clean'..msg.chat_id_) then
if DevLeo:get(ANTIQUES..'Abs:CleanNum'..msg.chat_id_) then CleanNum = DevLeo:get(ANTIQUES..'Abs:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevLeo:scard(ANTIQUES.."Abs:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevLeo:smembers(ANTIQUES.."Abs:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
DevLeo:del(ANTIQUES.."Abs:cleaner"..msg.chat_id_)
end 
end 
if Cleaner(msg) then
if DevLeo:get(ANTIQUES..'Abs:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevLeo:scard(ANTIQUES.."Abs:cleaner"..msg.chat_id_)
if M ~= 0 then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙عدد الميديا -› "..M.."\n⌔︙الحذف التلقائي -› "..(DevLeo:get(ANTIQUES..'Abs:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم تنظيف الميديا المعدله', 1, 'md')
end
--     SOURCE ANTIQUES     --
if ChatType == 'sp' or ChatType == 'gp'  then
if Admin(msg) then
...
if DevLeo:get(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم فتح التعديل")  
DevLeo:del(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
DevLeo:hdel(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevLeo:get(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم فتح التثبيت")  
DevLeo:del(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_)
DevLeo:srem(ANTIQUES.."Abs:Lock:Pinpin",msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Text'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Photo'..msg.chat_id_)
else
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevLeo:get(ANTIQUES..'Abs:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم فتح الكلايش")  
DevLeo:del(ANTIQUES..'Abs:Lock:Spam'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Join'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Videos'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Document'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Inline'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Markdown'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Gifs'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Music'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Voice'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Links'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Location'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Tags'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Hashtak'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Contact'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:WebLinks'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Arabic'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:English'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:TagServr'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Stickers'..msg.chat_id_)
else
...
DevLeo:del(ANTIQUES..'Abs:Lock:Forwards'..msg.chat_id_)
else
...
DevLeo:set(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_,"del") DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Abs:Lock:Links','Abs:Lock:Contact','Abs:Lock:Forwards','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:EditMsgs','Abs:Lock:Stickers','Abs:Lock:Farsi','Abs:Lock:Spam','Abs:Lock:WebLinks','Abs:Lock:Photo'}
for i,Lock in pairs(LockList) do
...
DevLeo:del(ANTIQUES..'Abs:Lock:Fshar'..msg.chat_id_) DevLeo:del(ANTIQUES..'Abs:Lock:Taf'..msg.chat_id_) DevLeo:del(ANTIQUES..'Abs:Lock:Kfr'..msg.chat_id_) 
DevLeo:set(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_,"del") DevLeo:hset(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Abs:Lock:EditMsgs','Abs:Lock:Farsi','Abs:Lock:TagServr','Abs:Lock:Inline','Abs:Lock:Photo','Abs:Lock:Spam','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:Music','Abs:Lock:Voice','Abs:Lock:Links','Abs:Lock:Location','Abs:Lock:Tags','Abs:Lock:Stickers','Abs:Lock:Markdown','Abs:Lock:Forwards','Abs:Lock:Document','Abs:Lock:Contact','Abs:Lock:Hashtak','Abs:Lock:WebLinks'}
for i,Lock in pairs(LockList) do
DevLeo:set(ANTIQUES..Lock..msg.chat_id_,true)
...
DevLeo:set(ANTIQUES..'Abs:Lock:Fshar'..msg.chat_id_,true) DevLeo:set(ANTIQUES..'Abs:Lock:Taf'..msg.chat_id_,true) DevLeo:set(ANTIQUES..'Abs:Lock:Kfr'..msg.chat_id_,true) DevLeo:hdel(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
UnLockList ={'Abs:Lock:EditMsgs','Abs:Lock:Text','Abs:Lock:Arabic','Abs:Lock:English','Abs:Lock:Join','Abs:Lock:Bots','Abs:Lock:Farsi','Abs:Lock:FarsiBan','Abs:Lock:TagServr','Abs:Lock:Inline','Abs:Lock:Photo','Abs:Lock:Spam','Abs:Lock:Videos','Abs:Lock:Gifs','Abs:Lock:Music','Abs:Lock:Voice','Abs:Lock:Links','Abs:Lock:Location','Abs:Lock:Tags','Abs:Lock:Stickers','Abs:Lock:Markdown','Abs:Lock:Forwards','Abs:Lock:Document','Abs:Lock:Contact','Abs:Lock:Hashtak','Abs:Lock:WebLinks'}
for i,UnLock in pairs(UnLockList) do
DevLeo:del(ANTIQUES..UnLock..msg.chat_id_)
end
...
DevLeo:set(ANTIQUES..'Abs:Spam:Text'..msg.chat_id_,SetSpam)
...
DevLeo:del(ANTIQUES.."Abs:mem:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:Cleaner:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:VipMem:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:Admins:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:Managers:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:Constructor:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:BasicConstructor:Rd"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:SudoBot:Rd"..msg.chat_id_)
end
end
--     SOURCE ANTIQUES     --
...
DevLeo:del(ANTIQUES..'Abs:AdminAll:')
end
...
DevLeo:del(ANTIQUES..'Abs:VipAll:')
end
...
DevLeo:del(ANTIQUES..'Abs:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
DevLeo:del(ANTIQUES..'Abs:AbsConstructor:'..msg.chat_id_)
...
DevLeo:del(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم حذف المنشئين")  
DevLeo:del(ANTIQUES..'Abs:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم حذف المدراء")  
DevLeo:del(ANTIQUES..'Abs:Managers:'..msg.chat_id_)
end 
...
DevLeo:del(ANTIQUES.."Abs:Groups:Links"..msg.chat_id_)
end
if txts[2] == 'المميزين' or txtss[2] == 'المميزين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم حذف المميزين")  
DevLeo:del(ANTIQUES..'Abs:VipMem:'..msg.chat_id_)
end
if txts[2] == 'المكتومين' or txtss[2] == 'المكتومين' then
DevLeo:del(ANTIQUES..'Abs:Muted:'..msg.chat_id_)
...
DevLeo:srem(ANTIQUES..'Abs:Tkeed:'..msg.chat_id_, v)
end 
...
DevLeo:del(ANTIQUES..'Abs:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌔︙تم حذف قوائم المنع")  
DevLeo:del(ANTIQUES..'Abs:Filters:'..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:FilterAnimation"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:FilterPhoto"..msg.chat_id_)
DevLeo:del(ANTIQUES.."Abs:FilterSteckr"..msg.chat_id_)
end
...
DevLeo:del(ANTIQUES..'Abs:Ban:'..msg.chat_id_) DevLeo:del(ANTIQUES..'Abs:Admins:'..msg.chat_id_) DevLeo:del(ANTIQUES..'User:Donky:'..msg.chat_id_) DevLeo:del(ANTIQUES..'Abs:VipMem:'..msg.chat_id_) DevLeo:del(ANTIQUES..'Abs:Filters:'..msg.chat_id_) DevLeo:del(ANTIQUES..'Abs:Muted:'..msg.chat_id_)
...
local basicconstructor = DevLeo:smembers(ANTIQUES..'Abs:BasicConstructor:'..msg.chat_id_)
local constructor = DevLeo:smembers(ANTIQUES..'Abs:Constructor:'..msg.chat_id_)
local Managers = DevLeo:smembers(ANTIQUES..'Abs:Managers:'..msg.chat_id_)
local admins = DevLeo:smembers(ANTIQUES..'Abs:Admins:'..msg.chat_id_)
local vipmem = DevLeo:smembers(ANTIQUES..'Abs:VipMem:'..msg.chat_id_)
...
spam_c = DevLeo:get(ANTIQUES..'Abs:Spam:Text'..msg.chat_id_)
end
--     SOURCE ANTIQUES     --
if DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     SOURCE ANTIQUES     --
if DevLeo:get(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevLeo:get(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevLeo:get(ANTIQUES.."Abs:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     SOURCE ANTIQUES     --
if DevLeo:get(ANTIQUES..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevLeo:get(ANTIQUES..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevLeo:get(ANTIQUES.."Abs:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevLeo:get(ANTIQUES..'Abs:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevLeo:hget(ANTIQUES.."Abs:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     SOURCE ANTIQUES     --
...
--     SOURCE ANTIQUES     --
if DevLeo:get(ANTIQUES..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevLeo:del(ANTIQUES..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevLeo:del(ANTIQUES..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:rules'..msg.chat_id_,text)
...
DevLeo:set(ANTIQUES..'Abs:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = DevLeo:get(ANTIQUES..'Abs:rules'..msg.chat_id_)
...
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل ميزة انطق'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Antk:Abs'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل ميزة انطق'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Antk:Abs'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevLeo:get(ANTIQUES..'Abs:Antk:Abs'..msg.chat_id_) and ChCheck(msg) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Zrf:Abs'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الزخرفه بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Zrf:Abs'..msg.chat_id_,true)  
end
if DevLeo:get(ANTIQUES..'Zrf:Abs'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر الزخرفه', 1, 'md')
DevLeo:del(ANTIQUES..'Zrf:Abs'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevLeo:get(ANTIQUES..'Abs:Zrf:Abs'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevLeo:setex(ANTIQUES.."Zrf:Abs"..msg.chat_id_..msg.sender_user_id_,300,true)
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Brg:Abs'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الابراج بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Brg:Abs'..msg.chat_id_,true)  
end
if not DevLeo:get(ANTIQUES..'Abs:Brg:Abs'..msg.chat_id_) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_) 
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_,true)  
end
if not DevLeo:get(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevLeo:set(ANTIQUES..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال -› جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevLeo:get(ANTIQUES..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر نسبة الحب ', 1, 'md')
DevLeo:del(ANTIQUES..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙نسبة الحب بين '..text..' هي : '..Abs..'%', 1, 'md')
DevLeo:del(ANTIQUES..'LoveNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevLeo:get(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_) then
if text == "نسبه الكره" and ChCheck(msg) or text == "نسبة الكره" and ChCheck(msg) then
DevLeo:set(ANTIQUES..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال -› جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevLeo:get(ANTIQUES..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر نسبة الكره ', 1, 'md')
DevLeo:del(ANTIQUES..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙نسبة الكره بين '..text..' هي : '..Abs..'%', 1, 'md')
DevLeo:del(ANTIQUES..'HataNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevLeo:get(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الرجوله" or text == "نسبة الرجوله" or text == "نسبه رجوله" or text == "نسبة رجوله") and ChCheck(msg) then
DevLeo:set(ANTIQUES..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال -› جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevLeo:get(ANTIQUES..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevLeo:del(ANTIQUES..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙نسبة رجولة '..text..' هي : '..Abs..'%', 1, 'md')
DevLeo:del(ANTIQUES..'RjolaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevLeo:get(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الانوثه" or text == "نسبة الانوثه" or text == "نسبه انوثه" or text == "نسبة انوثه") and ChCheck(msg) then
DevLeo:set(ANTIQUES..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال -› روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevLeo:get(ANTIQUES..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevLeo:del(ANTIQUES..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙نسبة انوثة '..text..' هي : '..Abs..'%', 1, 'md')
DevLeo:del(ANTIQUES..'AnothaNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevLeo:get(ANTIQUES..'Abs:Nsba:Abs'..msg.chat_id_) then
if text and (text == "نسبه الغباء" or text == "نسبة الغباء") and ChCheck(msg) then
DevLeo:set(ANTIQUES..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال -› جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevLeo:get(ANTIQUES..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevLeo:del(ANTIQUES..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abs = math.random(0,100);
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙نسبة غباء '..text..' هي : '..Abs..'%', 1, 'md')
DevLeo:del(ANTIQUES..'StupidNsba:Abs'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
--     SOURCE ANTIQUES     --
...
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Age:Abs'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل حساب العمر'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Age:Abs'..msg.chat_id_,true)  
end
if not DevLeo:get(ANTIQUES..'Abs:Age:Abs'..msg.chat_id_) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Mean:Abs'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل معاني الاسماء'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Mean:Abs'..msg.chat_id_,true)  
end
if not DevLeo:get(ANTIQUES..'Abs:Mean:Abs'..msg.chat_id_) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Audios:Abs'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل غنيلي بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Audios:Abs'..msg.chat_id_,true)  
end
if text == "غنيلي" and not DevLeo:get(ANTIQUES..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "متحركه" or text == "-› متحركه ᥀") and not DevLeo:get(ANTIQUES..'Abs:gif:Abs'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifANTIQUES/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text and (text == "ميمز" or text == "-› ميمز ᥀") and not DevLeo:get(ANTIQUES..'Abs:memz:Abs'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzANTIQUES/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     SOURCE ANTIQUES     --
if Admin(msg) then
if DevLeo:get(ANTIQUES..'Abs:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevLeo:get(ANTIQUES..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الروابط -› "..mute_links.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevLeo:get(ANTIQUES..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙المعرف -› "..lock_tag.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevLeo:get(ANTIQUES..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙المتحركه -› "..mute_gifs.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الملصقات" then if DevLeo:get(ANTIQUES..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الملصقات -› "..lock_sticker.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الصور" then if DevLeo:get(ANTIQUES..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الصور -› "..mute_photo.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevLeo:get(ANTIQUES..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الفيديو -› "..mute_video.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الاونلاين" then if DevLeo:get(ANTIQUES..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙الاونلاين -› "..mute_in.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الدردشه" then if DevLeo:get(ANTIQUES..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الدردشه -› "..mute_text.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevLeo:get(ANTIQUES..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙التوجيه -› "..lock_forward.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الاغاني" then if DevLeo:get(ANTIQUES..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الاغاني -› "..mute_music.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevLeo:get(ANTIQUES..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙الصوت -› "..mute_voice.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevLeo:get(ANTIQUES..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الجهات -› "..lock_contact.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الماركداون" then if DevLeo:get(ANTIQUES..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙الماركداون -› "..markdown.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الهاشتاك" then if DevLeo:get(ANTIQUES..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙الهاشتاك -› "..lock_htag.."\n"Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "التعديل" then if DevLeo:get(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙التعديل -› "..mute_edit.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "التثبيت" then if DevLeo:get(ANTIQUES..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙التثبيت -› "..lock_pin.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الاشعارات" then if DevLeo:get(ANTIQUES..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الاشعارات -› "..lock_tgservice.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الكلايش" then if DevLeo:get(ANTIQUES..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الكلايش -› "..lock_spam.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الدخول" then if DevLeo:get(ANTIQUES..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local ANTIQUESTEAM = "\n" .."⌔︙الدخول -› "..lock_Join.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الشبكات" then if DevLeo:get(ANTIQUES..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الشبكات -› "..lock_wp.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "المواقع" then if DevLeo:get(ANTIQUES..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙المواقع -› "..lock_location.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "العربيه" then if DevLeo:get(ANTIQUES..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙العربيه -› "..lock_arabic.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الانكليزيه" then if DevLeo:get(ANTIQUES..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local ANTIQUESTEAM = "\n" .."⌔︙الانكليزيه -› "..lock_english.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الكفر" then if DevLeo:get(ANTIQUES..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local ANTIQUESTEAM = "\n" .."⌔︙الكفر -› "..lock_kaf.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الفشار" then if DevLeo:get(ANTIQUES..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local ANTIQUESTEAM = "\n" .."⌔︙الفشار -› "..lock_fshar.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
if text == "الطائفيه" then if DevLeo:get(ANTIQUES..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local ANTIQUESTEAM = "\n" .."⌔︙الطائفيه -› "..lock_taf.."\n" Dev_Leo(msg.chat_id_, msg.id_, 1, ANTIQUESTEAM, 1, 'md') end
end
--     SOURCE ANTIQUES     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل كشف الاعدادات'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل كشف الاعدادات'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:LockSettings'..msg.chat_id_) 
end
--     SOURCE ANTIQUES     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل اوامر التحشيش'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل اوامر التحشيش'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:Stupid'..msg.chat_id_,true)
end
--     SOURCE ANTIQUES     --
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:Robot'..msg.chat_id_)
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:Robot'..msg.chat_id_,true)
end
--     SOURCE ANTIQUES     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل ردود المدير'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل ردود المدير'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:GpRed'..msg.chat_id_,true)
end
--     SOURCE ANTIQUES     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل ردود المطور'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل ردود المطور'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:AllRed'..msg.chat_id_,true)
end
--     SOURCE ANTIQUES     --
if SecondSudo(msg) then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES.."Abs:Left:Bot"..ANTIQUES)
end
if text == 'تعطيل المغادره' or text == '-› تعطيل المغادره ⌁' then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل المغادره بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES.."Abs:Left:Bot"..ANTIQUES,true) 
end 
if text == 'تفعيل الاذاعه' or text == '-› تفعيل الاذاعه ⌁' then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل الاذاعه بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES.."Abs:Send:Bot"..ANTIQUES)
end
if text == 'تعطيل الاذاعه' or text == '-› تعطيل الاذاعه ⌁' then 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الاذاعه بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES.."Abs:Send:Bot"..ANTIQUES,true) 
end
end
--     SOURCE ANTIQUES     --
...
--     SOURCE ANTIQUES     --
if msg.content_.photo_ then
if DevLeo:get(ANTIQUES..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevLeo:del(ANTIQUES..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"⌔︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevLeo:del(ANTIQUES..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevLeo:set(ANTIQUES..'Abs:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     SOURCE ANTIQUES     --
...
if data.ID == "Ok" then
DevLeo:del(ANTIQUES..'Abs:PinnedMsg'..msg.chat_id_)
...
local PinId = DevLeo:get(ANTIQUES..'Abs:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevLeo:del(ANTIQUES..'Abs:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevLeo:scard(ANTIQUES.."Abs:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevLeo:scard(ANTIQUES.."Abs:Constructor:"..ChatId) or 0
local BanedList = DevLeo:scard(ANTIQUES.."Abs:Ban:"..ChatId) or 0
local ManagerList = DevLeo:scard(ANTIQUES.."Abs:Managers:"..ChatId) or 0
local MutedList = DevLeo:scard(ANTIQUES.."Abs:Muted:"..ChatId) or 0
local TkeedList = DevLeo:scard(ANTIQUES.."Abs:Abs:Tkeed:"..ChatId) or 0
local AdminsList = DevLeo:scard(ANTIQUES.."Abs:Admins:"..ChatId) or 0
local VipList = DevLeo:scard(ANTIQUES.."Abs:VipMem:"..ChatId) or 0
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "HAQEK")..")"
else 
...
DevLeo:srem(ANTIQUES.."Abs:Groups", dp.id_)
else
...
DevLeo:set(ANTIQUES..'Abs:Num:Add:Bot',Num) 
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:FreeBot'..ANTIQUES) 
end 
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:FreeBot'..ANTIQUES,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES..'Abs:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تعطيل الالعاب بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES..'Abs:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل جلب رابط المجموعه'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:del(ANTIQUES.."Abs:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
DevLeo:set(ANTIQUES.."Abs:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
--     SOURCE ANTIQUES     --
...
ReplyStatus(msg,result.id_,"ReplyBy","⌔︙تم تفعيل المجموعه "..dp.title_)  
DevLeo:sadd(ANTIQUES.."Abs:Groups",msg.chat_id_)
if not DevLeo:get(ANTIQUES..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevLeo:incrby(ANTIQUES..'Abs:Sudos'..msg.sender_user_id_,1)
DevLeo:set(ANTIQUES..'Abs:SudosGp'..msg.sender_user_id_..msg.chat_id_,"abs")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevLeo:sismember(ANTIQUES..'Abs:Groups',msg.chat_id_) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './ANTIQUES.lua', '⌔︙نسخة ملف سورس انتيكا',dl_cb, nil)
end end
--     SOURCE ANTIQUES     --
...
for k,v in pairs(List) do
local GroupsManagers = DevLeo:scard(ANTIQUES.."Abs:Managers:"..v) or 0
local GroupsAdmins = DevLeo:scard(ANTIQUES.."Abs:Admins:"..v) or 0
local Groupslink = DevLeo:get(ANTIQUES.."Abs:Groups:Links" ..v)
...
DevLeo:setex(ANTIQUES.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙ارسل لي سواء -› ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌔︙للخروج ارسل -› ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(ANTIQUES.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevLeo:smembers(ANTIQUES..'Abs:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
AbsText = "الرساله"
...
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم اذاعة "..AbsText.." بنجاح \n⌔︙‏الى -› ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
end
--     SOURCE ANTIQUES     --
...
DevLeo:setex(ANTIQUES.."Abs:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙ارسل لي سواء -› ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌔︙للخروج ارسل -› ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(ANTIQUES.."Abs:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevLeo:smembers(ANTIQUES..'Abs:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
AbsText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevLeo:setex(ANTIQUES.."Abs:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙ارسل الرساله الان لتوجيها \n⌔︙للخروج ارسل -› ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(ANTIQUES.."Abs:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevLeo:smembers(ANTIQUES..'Abs:Groups')   
for k,v in pairs(List) do  
...
DevLeo:setex(ANTIQUES.."Abs:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙ارسل الرساله الان لتوجيها \n⌔︙للخروج ارسل -› ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(ANTIQUES.."Abs:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevLeo:smembers(ANTIQUES..'Abs:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم اذاعة رسالتك بالتوجيه \n⌔︙‏الى -› ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevLeo:setex(ANTIQUES.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙ارسل لي سواء -› ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌔︙للخروج ارسل -› ( الغاء ) \n ✓'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(ANTIQUES.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevLeo:smembers(ANTIQUES.."Abs:Groups") 
if msg.content_.text_ then
...
AbsText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
AbsText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
AbsText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
AbsText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
AbsText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
AbsText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
AbsText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
AbsText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevLeo:set(ANTIQUES..'Abs:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم اذاعة "..AbsText.." بالتثبيت \n⌔︙‏في -› ❨ "..#List.." ❩ مجموعه \n ✓", 1, 'md')
DevLeo:del(ANTIQUES.."Abs:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end
--     SOURCE ANTIQUES     --
if text == 'حذف رد من متعدد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد من متعدد' and Manager(msg) and ChCheck(msg) then
local List = DevLeo:smembers(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
DevLeo:set(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevLeo:sismember(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_,text) then
...
DevLeo:set(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevLeo:set(ANTIQUES..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevLeo:set(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
DevLeo:set(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = DevLeo:get(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevLeo:set(ANTIQUES..'Abs:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevLeo:set(ANTIQUES..'Abs:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevLeo:sadd(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     SOURCE ANTIQUES     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = DevLeo:smembers(ANTIQUES..'Abs:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevLeo:set(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and Manager(msg) and ChCheck(msg) then
DevLeo:set(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevLeo:get(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevLeo:set(ANTIQUES..'Abs:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevLeo:set(ANTIQUES..'Abs:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevLeo:sadd(ANTIQUES..'Abs:Manager:GpRed'..msg.chat_id_,text)
...
local List = DevLeo:smembers(ANTIQUES.."Abs:Sudo:AllRed")
if #List == 0 then
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevLeo:set(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد عام' and SecondSudo(msg) or text == '-› اضف رد عام ⌁' and SecondSudo(msg) then
DevLeo:set(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = DevLeo:get(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_)
...
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙ارسل لي الرد سواء كان -› ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌔︙يمكنك اضافة الى النص -› ⤈\n━─━─━─ ⌔ ─━─━─━\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n━─━─━─ ⌔ ─━─━─━\n⌔︙للخروج ارسل -› ( الغاء )\n ✓" ,  1, "md")
DevLeo:set(ANTIQUES.."Abs:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevLeo:set(ANTIQUES.."Abs:Add:AllText"..msg.sender_user_id_, text)
DevLeo:sadd(ANTIQUES.."Abs:Sudo:AllRed",text)
DevLeo:set(ANTIQUES.."DelSudoRep",text)
return false 
end end
--     SOURCE ANTIQUES     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = DevLeo:smembers(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_)
MsgRep = '⌔︙قائمة الردود المتعدده -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد -› '..#DevLeo:smembers(ANTIQUES..'Abs:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
DevLeo:del(ANTIQUES..'Abs:Text:GpTexts'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevLeo:smembers(ANTIQUES..'Abs:Manager:GpRed'..msg.chat_id_)
MsgRep = '⌔︙ردود المدير -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n'
for k,v in pairs(redod) do
if DevLeo:get(ANTIQUES.."Abs:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevLeo:get(ANTIQUES.."Abs:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevLeo:get(ANTIQUES.."Abs:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevLeo:get(ANTIQUES.."Abs:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevLeo:get(ANTIQUES.."Abs:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevLeo:get(ANTIQUES.."Abs:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevLeo:get(ANTIQUES.."Abs:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevLeo:get(ANTIQUES.."Abs:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevLeo:del(ANTIQUES..'Abs:Gif:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Voice:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Audio:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Photo:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Stecker:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Video:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:File:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Text:GpRed'..v..msg.chat_id_)
DevLeo:del(ANTIQUES..'Abs:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevLeo:smembers(ANTIQUES.."Abs:Sudo:AllRed")
MsgRep = '⌔︙ردود المطور -› ⤈ \n━─━─━─ ⌔ ─━─━─━\n'
for k,v in pairs(redod) do
if DevLeo:get(ANTIQUES.."Abs:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevLeo:get(ANTIQUES.."Abs:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevLeo:get(ANTIQUES.."Abs:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevLeo:get(ANTIQUES.."Abs:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevLeo:get(ANTIQUES.."Abs:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevLeo:get(ANTIQUES.."Abs:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevLeo:get(ANTIQUES.."Abs:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevLeo:get(ANTIQUES.."Abs:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) -› {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevLeo:del(ANTIQUES.."Abs:Add:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Gif:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Voice:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Audio:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Photo:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Stecker:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Video:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:File:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Text:AllRed"..v)
DevLeo:del(ANTIQUES.."Abs:Sudo:AllRed")
end
...
DevLeo:set(ANTIQUES..'Abs:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevLeo:del(ANTIQUES..'Abs:NameBot')
local ANTIQUESTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم حذف اسم البوت'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ANTIQUESTEAM, 14, string.len(msg.sender_user_id_))
end end 
--     SOURCE ANTIQUES     --
...
DevLeo:set(ANTIQUES..'Abs:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help0'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help0'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(ANTIQUES..'Abs:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help01'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then 
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help01'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help1', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(ANTIQUES..'Abs:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help21'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help21'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help2', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(ANTIQUES..'Abs:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help31'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help31'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help3', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(ANTIQUES..'Abs:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help41'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help41'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help4', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevLeo:set(ANTIQUES..'Abs:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help51'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help51'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help5', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(ANTIQUES..'Abs:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ANTIQUESTEAM =  DevLeo:get(ANTIQUES..'Abs:Help61'..msg.sender_user_id_)
if ANTIQUESTEAM == 'msg' then
Dev_Leo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(ANTIQUES..'Abs:Help61'..msg.sender_user_id_)
DevLeo:set(ANTIQUES..'Abs:Help6', text)
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
os.execute('wget https://raw.githubusercontent.com/TEAMANTIQUES/ANTIQUES/master/ANTIQUES.lua') 
dofile('ANTIQUES.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMANTIQUES/ANTIQUES_Files/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔︙قائمة ملفات متجر سورس انتيكا\n⌔︙الملفات المتوفره حاليا -› ⤈\n━─━─━─ ⌔ ─━─━─━\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/TEAMANTIQUES/ANTIQUES_Files/master/ANTIQUES_Files/"..FileName)
if Res == 200 then
...
DevLeo:del(ANTIQUES..'Abs:Text:BotWelcome')
DevLeo:del(ANTIQUES..'Abs:Photo:BotWelcome')
return false
end 
...
DevLeo:del(ANTIQUES..'Abs:Lock:BotWelcome')
return false
end 
...
DevLeo:set(ANTIQUES..'Abs:Lock:BotWelcome',true)
return false
end 
...
DevLeo:del(ANTIQUES..'Abs:Text:BotWelcome')
DevLeo:del(ANTIQUES..'Abs:Photo:BotWelcome')
DevLeo:set(ANTIQUES.."Abs:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevLeo:get(ANTIQUES.."Abs:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم الغاء الامر", 1, "md") 
DevLeo:del(ANTIQUES.."Abs:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Leo(msg.chat_id_, msg.id_, 1, "⌔︙تم حفظ النص ارسل لي صورة الترحيب\n⌔︙ارسل -› الغاء لحفظ النص فقط", 1, 'md')   
DevLeo:set(ANTIQUES.."Abs:Text:BotWelcome",text) 
DevLeo:set(ANTIQUES.."Abs:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevLeo:get(ANTIQUES.."Abs:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevLeo:set(ANTIQUES.."Abs:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevLeo:setex(ANTIQUES.."Abs:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevLeo:set(ANTIQUES..'Abs:ChText',texxt)
...
DevLeo:del(ANTIQUES..'Abs:ChText')
...
Dev_Leo(msg.chat_id_, msg.id_, 1, '⌔︙Channel ↬ [@HAQEK]', 1, 'md')    
end 
--     SOURCE ANTIQUES     --
...
DevLeo:incr(ANTIQUES..'Abs:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevLeo:get(ANTIQUES..'Abs:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
local GetMsgPin = DevLeo:get(ANTIQUES..'Abs:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevLeo:del(ANTIQUES..'Abs:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevLeo:del(ANTIQUES..'Abs:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevLeo:srem(ANTIQUES..'Abs:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevLeo:srem(ANTIQUES..'Abs:Groups',v)  
end
...
DevLeo:sadd(ANTIQUES..'Abs:Groups',v)  
end end,nil) end
end
--     SOURCE ANTIQUES     --
end 
